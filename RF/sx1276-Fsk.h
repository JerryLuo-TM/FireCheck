...
*******************************************************************/
#define DEF_FIFO                                    0x00
// Common settings
#define DEF_OPMODE                                  0x09
#define DEF_BITRATEMSB                              0x1A
#define DEF_BITRATELSB                              0x0B
#define DEF_FDEVMSB                                 0x00
#define DEF_FDEVLSB                                 0x52
#define DEF_FRFMSB                                  0x6C
#define DEF_FRFMID                                  0x80
#define DEF_FRFLSB                                  0x00
// Tx settings
#define DEF_PACONFIG                                0x4F
#define DEF_PARAMP                                  0x09
#define DEF_OCP                                     0x2B
// Rx settings
#define DEF_LNA                                     0x20
#define DEF_RXCONFIG                                0x08
#define DEF_RSSICONFIG                              0x02
#define DEF_RSSICOLLISION                           0x0A
#define DEF_RSSITHRESH                              0xFF

#define DEF_RXBW                                    0x15
#define DEF_AFCBW                                   0x0B
#define DEF_OOKPEAK                                 0x28
#define DEF_OOKFIX                                  0x0C
#define DEF_OOKAVG                                  0x12
#define DEF_RES17                                   0x47
#define DEF_RES18                                   0x32
#define DEF_RES19                                   0x3E
...
#define DEF_PACKETCONFIG1                           0x90
#define DEF_PACKETCONFIG2                           0x40
#define DEF_PAYLOADLENGTH                           0x40
#define DEF_NODEADRS                                0x00
#define DEF_BROADCASTADRS                           0x00
#define DEF_FIFOTHRESH                              0x0F
// SM settings
#define DEF_SEQCONFIG1                              0x00
#define DEF_SEQCONFIG2                              0x00
#define DEF_TIMERRESOL                              0x00
#define DEF_TIMER1COEF                              0xF5
#define DEF_TIMER2COEF                              0x20
// Service settings
#define DEF_IMAGECAL                                0x82

#define DEF_LOWBAT                                  0x02
// Status
...
#define DEF_PADAC                                   0x84

#define DEF_BITRATEFRAC                             0x00
 ...
 * RegBitRate (bits/sec)
 */
#define RF_BITRATEMSB_1000_BPS                      0x7D
#define RF_BITRATELSB_1000_BPS                      0x00

#define RF_BITRATEMSB_10000_BPS                     0xC8
#define RF_BITRATELSB_10000_BPS                     0x00

#define RF_BITRATEMSB_20000_BPS                     0x06
#define RF_BITRATELSB_20000_BPS                     0x40
...
typedef enum
{
    PKT_FORMAT_FIXED             =   0x00,       //fixed packet
    PKT_FORMAT_VARIABLE          =   0x01,       //variable packet
}PKT_FORMAT;
...
/* Process the Fsk modem Rx state machines depending on the SX1276 operating mode */
